                ...
                <h2>MEDI VIEW HUB : PREMIERE AU SENEGAL</h2>
                  ...
                  <div class="team text-center mt-5">
                    ...
                    <p class="front-page">Medi View Hub est composé d'une équipe dynamique de trois ingénieurs en IA et Big Data qui veulent ambitionner le monde d'imagerie médicale en Afrique et au Sénégal en particulier. <br>
                        Pour cela, ils innovent en mettant en place une plateforme comme celle-là dans le but de faire exceller ↗️ le Sénégal dans la téléradiologie en travaillant ardemment avec leur moyen de bord. <br>
                      Vous êtes jeune, aimant le challenge et voulant faire bouger les choses, alors rejoignez l'équipe ! </p>
