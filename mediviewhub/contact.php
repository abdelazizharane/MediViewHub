          ...
          <div class="row">
            <div class="main col-lg-8">
              <div class="contact-page">
                <h2 class="underscore mb-5">Laissez-nous savoir si vous avez des questions 📧</h2>
                <div class="line"></div>
                <p>N'hésitez pas à nous contacter pour plus d'informations <br> Vous serez contacter sous 24h.</p>
                <div class="line"></div>
                <form id="contactForm">
                  <!-- Nom input -->
                  <div class="mb-3">
